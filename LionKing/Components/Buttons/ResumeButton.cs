...
public class ResumeButton : Component
{
    ...
    private string _buttonText = "Resume";
    private Color _hoverColor;


    public ResumeButton(SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Rectangle rectangle, Color idleColor, Color clickedColor, Color hoverColor, SpriteFont font)
    {
